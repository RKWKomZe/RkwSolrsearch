 ...
 */
class AddFacetItemUniqueViewHelper extends \ApacheSolrForTypo3\Solr\ViewHelpers\Uri\Facet\AbstractValueViewHelper
{
    /**
    ...
    public static function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        $uri = self::getSearchUriBuilder($renderingContext)->getAddUniqueFacetValueUri($previousRequest, $name, $itemValue);
        return $uri;
    }
}
